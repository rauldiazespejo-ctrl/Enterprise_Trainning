...
const AssignmentManagement: React.FC = () => {
  ...
  // Performance Optimization: O(1) lookups for users and courses during assignment enrichment
  ...
  const enrichedAssignments = useMemo(() => assignments.map(a => {
  ...
  // Performance Optimization: Memoize filtered assignments to prevent re-filtering on unrelated renders
