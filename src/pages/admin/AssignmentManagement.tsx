...
const AssignmentManagement: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Pre-compute users and courses into O(1) Map lookups to avoid O(N*M) complexity inside enrichedAssignments .map()
  ...
  // ⚡ Bolt Optimization: Wrapped derived assignments array in useMemo to prevent synchronous recalculation on every render
