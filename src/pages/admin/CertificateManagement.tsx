...
const CertificateManagement: React.FC = () => {
  ...
  const filteredRows = useMemo(() => {
    ...
    return rows.filter(cert =>
      cert.employeeName.toLowerCase().includes(lowerSearchTerm) ||
      cert.employeeEmail.toLowerCase().includes(lowerSearchTerm) ||
      cert.courseName.toLowerCase().includes(lowerSearchTerm) ||
      cert.verificationCode.toLowerCase().includes(lowerSearchTerm)
    );
  }, [rows, searchTerm]);
