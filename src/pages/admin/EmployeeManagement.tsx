...
const EmployeeManagement: React.FC = () => {
  ...
  const statsMap = useMemo(() => {
    ...
    // Inicializar para todos los empleados
    employees.forEach(e => {
      map.set(e.id, { completed: 0, inProgress: 0, certificates: 0 });
    });

    // Procesar assignments de una pasada
    ...
    // Procesar certificates de una pasada
