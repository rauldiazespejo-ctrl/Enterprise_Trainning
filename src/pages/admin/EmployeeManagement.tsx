...
const EmployeeManagement: React.FC = () => {
  ...
  // Pre-calculate all employee stats in a single pass O(N + M + C)
  // instead of filtering assignments and certificates per employee O(N * (M + C)).
  // This drastically reduces iterations and prevents UI lag when scaling users.
  ...
  const employeeStats = React.useCallback((employeeId: string) => {
    return statsMap.get(employeeId) || DEFAULT_STATS;
  }, [statsMap]);
