    ...
    <div className={`flex items-center justify-between ${className}`}>
      ...
      <nav aria-label="Navegación de páginas" className="flex items-center gap-1">
        ...
        <button
          ...
          className="focus-ring p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        ...
        {pageNumbers.map((page, index) => (
          typeof page === 'number' ? (
            <button
              ...
              className={`focus-ring min-w-[40px] h-10 px-3 rounded-lg font-medium transition-colors ${
                currentPage === page
                  ? 'bg-brand text-white'
